...
import styles from './homepage.module.css'; // Adjusted the import to reference the correct path
import { Link, NavLink } from "react-router-dom"; // For navigation
import GoalSpree from '../Savings/savings';
  ...
  return (
    <Dashboard>
      ...
      {/* <div className={styles.containerLayout}> */}
        {/* <img src={logoforbank} className={styles.logoImage} alt="NobleTrust Bank Logo" /> */}
        <div>
          {/* <Link to="#" className={styles.containerLink}> */}
            {/* <i className={styles.containerIcon + ' bx bx-notification'}></i> */}
          {/* </Link> */}
          {/* <span className={styles.containerTooltip}>Notification</span> */}
        {/* </div> */}
      {/* </div> */}
        ...
        <div className={`${styles.accountCard} ${styles.accountCardHover}`}>
          ...
          <ul className={styles.cardList}>
            <li className={styles.cardListItem}>
             ...
             <li className={styles.cardListItem}>
             <Link className={styles.iconContainer} to="/save">
